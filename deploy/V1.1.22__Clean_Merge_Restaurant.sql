...
(
    ...
    try_cast(cusinetype as string) as CUISINE_TYPE,
    ...
    TO_TIMESTAMP_TZ(CreatedDate, 'YYYY-MM-DD HH24:MI:SS') as created_date,
    TO_TIMESTAMP_TZ(ModifiedDate, 'YYYY-MM-DD HH24:MI:SS') as modified_date,
    stg_file_name,
    stg_file_load_ts,
    stg_file_md5,
