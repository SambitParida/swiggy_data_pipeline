...
CREATE OR REPLACE TABLE CONSUMPTION_SCH.RESTAURANT_DIM (
        ...
        CURRENT_FLAG BOOLEAN -- INDICATES WHETHER THE RECORD IS THE CURRENT VERSION
    );
CREATE OR REPLACE TABLE CONSUMPTION_SCH.CUSTOMER_DIM (
        ...
        CURRENT_FLAG BOOLEAN -- FLAG TO INDICATE THE CURRENT RECORD
    );
...
CREATE OR REPLACE TABLE CONSUMPTION_SCH.MENU_DIM (
        ...
        CURRENT_FLAG BOOLEAN -- FLAG TO INDICATE IF THE RECORD IS CURRENT (TRUE/FALSE)
    );
CREATE OR REPLACE TABLE CONSUMPTION_SCH.DELIVERY_AGENT_DIM (
        ...
        EFF_START_DT TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
        -- EFFECTIVE START DATE
